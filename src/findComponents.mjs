...
export function findComponents(inputPath, ignorePatterns, isPascalCase) {
  return searchFiles(
    ...
    isPascalCase
      ? /(export default function|export const|export default|export declare const|export interface) ([A-Z][a-zA-Z]+)/g
      : /(export default function|export const|export default|export declare const|export interface) ([a-zA-Z]+)/g,
    2,
  );
}
